...
class ModelParams(ParamGroup):
    ...
    #     # [NEW] 두 번째 경로도 절대 경로로 변환 (입력되었을 경우)
    #     if hasattr(args, "source_path_2") and args.source_path_2:
    #          g.source_path_2 = osp.abspath(args.source_path_2)
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.scaling_lr_init = 0.005 # 0.005
        self.scaling_lr_final = 0.0005 # 0.0005
        self.scaling_lr_max_steps = 30_000
        self.rotation_lr_init = 0.001 # 0.001
        self.rotation_lr_final = 0.0001 # 0.0001
        self.rotation_lr_max_steps = 30_000
        self.lambda_dssim = 0.5
        self.lambda_tv = 0.05 #0.05
        self.tv_vol_size = 32
        self.density_min_threshold = 0.00001 # 0.00001
        ...
        self.max_num_gaussians = 500_000 #500_000
        self.alpha_lr_init  = 0.01   # = density_lr_init * 0.1
        self.alpha_lr_final = 0.0001  # = density_lr_final * 0.1
