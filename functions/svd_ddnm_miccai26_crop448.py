...
def ddnm_plus_diffusion(x, model, b, eta, A_funcs, y, sigma_y, temp_y_original=None, temp_y_cgls=None, cls_fn=None, classes=None, config=None, args=None, idx_so_far=0):
    with torch.no_grad():
