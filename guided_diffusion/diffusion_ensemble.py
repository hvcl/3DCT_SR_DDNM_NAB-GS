...
class Diffusion(object):
    def __init__(self, args, config, device=None):
        ...
        from functions.svd_ddnm import ddnm_diffusion, ddnm_plus_diffusion
        if "perProj" in self.args.image_folder:
            from functions.svd_ddnm_perProj import ddnm_diffusion, ddnm_plus_diffusion
        elif "lessSteps" in self.args.image_folder:
            from functions.svd_ddnm_lessSteps_ensemble import ddnm_diffusion, ddnm_plus_diffusion
    ...
    def sample(self, simplified):
        ...
        # if "Final" in self.args.image_folder:
