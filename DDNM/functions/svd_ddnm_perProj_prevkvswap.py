...
def _predict_eps_with_optional_ref(model, xt, t, ref_y, at, cls_fn=None, classes=None):
    """
    ...
    with torch.no_grad():
        ...
        for t_idx, (i, j) in tqdm(enumerate(time_pairs)):
            ...
            if j < i: # normal sampling 
                ...
                et = _predict_eps_with_optional_ref(model, xt, t, ref_y, at, cls_fn=cls_fn, classes=classes)
